...
public class LogProcessBolt extends BaseRichBolt {
    ...
    public void execute(Tuple input) {
        ...
        try {
            ...
            System.err.println(phone + "," + longitude + "," + latitude + "," + time);

            String rowKey = longitude + "_" + latitude;

            collector.emit(new Values(time, Double.parseDouble(longitude), Double.parseDouble(latitude), rowKey));
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("time", "longitude", "latitude", "rowKey"));
    }
}
